...
fn setup(
    ...
    commands.spawn((
        ...
        TextColor(CHARTEXT),
        Transform::from_translation(Vec3::new(-572., -366., (Z_UI + 1) as f32)).with_scale(Vec3::ONE / 4.),
    ));
    commands.spawn((
        Visibility::Hidden,
        ZIndex(Z_TEXT),
        ...
        TextColor(VNTEXT),
        Transform::from_translation(Vec3::new(-550., -420., (Z_UI + 1) as f32)).with_scale(Vec3::ONE / 4.),
    ));
}
