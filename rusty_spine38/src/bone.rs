use crate::{
    c::{
        spBone, spBoneData, spBone_getWorldRotationX_38, spBone_getWorldRotationY_38,
        spBone_getWorldScaleX_38, spBone_getWorldScaleY_38, spBone_isYDown_38, spBone_localToWorld_38,
        spBone_rotateWorld_38, spBone_setToSetupPose_38, spBone_setYDown_38, spBone_updateAppliedTransform_38,
        spBone_updateWorldTransform_38, spBone_updateWorldTransformWith_38, spBone_worldToLocal_38,
        spBone_worldToLocalRotation_38, spSkeleton,
    },
...
impl Bone {
    ...
    pub fn set_to_setup_pose(&mut self) {
        unsafe {
            spBone_setToSetupPose_38(self.c_ptr());
        }
    }
    ...
    pub fn update_world_transform(&mut self) {
        unsafe {
            spBone_updateWorldTransform_38(self.c_ptr());
        }
    }
    ...
    pub fn update_applied_transform(&mut self) {
        unsafe {
            spBone_updateAppliedTransform_38(self.c_ptr());
        }
    }
    ...
    pub fn world_scale_x(&self) -> f32 {
        unsafe { spBone_getWorldScaleX_38(self.c_ptr()) }
    }
    ...
    pub fn world_scale_y(&self) -> f32 {
        unsafe { spBone_getWorldScaleY_38(self.c_ptr()) }
    }
    ...
    pub fn world_to_local(&self, world_x: f32, world_y: f32) -> (f32, f32) {
        ...
        unsafe {
            spBone_worldToLocal_38(self.c_ptr(), world_x, world_y, &mut local_x, &mut local_y);
        }
        (local_x, local_y)
    }
    ...
    pub fn local_to_world(&self, local_x: f32, local_y: f32) -> (f32, f32) {
        ...
        unsafe {
            spBone_localToWorld_38(self.c_ptr(), local_x, local_y, &mut world_x, &mut world_y);
        }
        (world_x, world_y)
    }
    ...
    pub fn world_to_local_rotation(&self, world_rotation: f32) -> f32 {
        unsafe { spBone_worldToLocalRotation_38(self.c_ptr(), world_rotation) }
    }

    /// Transforms a local rotation to a world rotation.
    #[must_use]
    pub fn local_to_world_rotation(&self, local_rotation: f32) -> f32 {
        unsafe { spBone_worldToLocalRotation_38(self.c_ptr(), local_rotation) }
    }
    ...
    pub fn rotate_world(&self, degrees: f32) {
        unsafe {
            spBone_rotateWorld_38(self.c_ptr(), degrees);
        }
    }
    ...
    pub fn set_y_down(y_down: bool) {
        unsafe {
            spBone_setYDown_38(i32::from(y_down));
        }
    }

    #[must_use]
    pub fn is_y_down() -> bool {
        unsafe { spBone_isYDown_38() != 0 }
    }
