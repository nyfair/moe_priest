...
use crate::{
    bone::Bone,
    c::{
        spBone, spIkConstraint, spPathConstraint, spSkeleton, spSkeletonData, spSkeleton_create_38,
        spSkeleton_dispose_38, spSkeleton_getAttachmentForSlotIndex_38,
        spSkeleton_getAttachmentForSlotName_38, spSkeleton_setAttachment_38,
        spSkeleton_setBonesToSetupPose_38, spSkeleton_setSkin_38, spSkeleton_setSkinByName_38,
        spSkeleton_setSlotsToSetupPose_38, spSkeleton_setToSetupPose_38, spSkeleton_update_38,
        spSkeleton_updateCache_38, spSkeleton_updateWorldTransform_38, spSkin, spSlot,
...
impl Skeleton {
    ...
    pub fn new(skeleton_data: Arc<SkeletonData>) -> Self {
        let c_skeleton = unsafe { spSkeleton_create_38(skeleton_data.c_ptr()) };
        Self {
    ...
    pub fn update(&mut self, delta: f32) {
        unsafe {
            spSkeleton_update_38(self.c_ptr(), delta);
        }
    }
    ...
    pub fn update_cache(&mut self) {
        unsafe {
            spSkeleton_updateCache_38(self.c_ptr());
        }
    }
    ...
    pub fn update_world_transform(&mut self) {
        unsafe {
            spSkeleton_updateWorldTransform_38(self.c_ptr());
        }
    }
    ...
    pub fn set_to_setup_pose(&mut self) {
        unsafe {
            spSkeleton_setToSetupPose_38(self.c_ptr());
        }
    }
    ...
    pub fn set_bones_to_setup_pose(&mut self) {
        unsafe {
            spSkeleton_setBonesToSetupPose_38(self.c_ptr());
        }
    }
    ...
    pub fn set_slots_to_setup_pose(&mut self) {
        unsafe {
            spSkeleton_setSlotsToSetupPose_38(self.c_ptr());
        }
    }
    ...
    pub unsafe fn set_skin(&mut self, skin: &Skin) {
        if skin.owns_memory {
            ...
            unsafe { spSkeleton_setSkin_38(self.c_ptr(), cloned_skin.c_ptr()) };
            self._skin = Some(cloned_skin);
        } else {
            unsafe { spSkeleton_setSkin_38(self.c_ptr(), skin.c_ptr()) };
            self._skin = None;
        }
    ...
    pub unsafe fn set_skin_unchecked(&mut self, skin: &Skin) {
        spSkeleton_setSkin_38(self.c_ptr(), skin.c_ptr());
    }
    ...
    pub unsafe fn set_skin_by_name_unchecked(&mut self, skin_name: &str) {
        ...
        spSkeleton_setSkinByName_38(self.c_ptr(), c_skin_name.as_ptr());
        self._skin = None;
    }
    ...
    pub fn set_attachment(&mut self, slot_name: &str, attachment_name: Option<&str>) -> bool {
        ...
        attachment_name.map_or_else(
            || unsafe {
                spSkeleton_setAttachment_38(self.c_ptr(), c_slot_name.as_ptr(), std::ptr::null()) != 0
            },
            |attachment_name| {
                let c_attachment_name = to_c_str(attachment_name);
                unsafe {
                    spSkeleton_setAttachment_38(
                        self.c_ptr(),
                        c_slot_name.as_ptr(),
    ...
    pub fn get_attachment_for_slot_name(
        ...
        let c_attachment_name = to_c_str(attachment_name);
        unsafe {
            let c_attachment = spSkeleton_getAttachmentForSlotName_38(
                self.c_ptr(),
                c_slot_name.as_ptr(),
                c_attachment_name.as_ptr(),
            );
    ...
    pub fn get_attachment_for_slot_index(
        ...
        let c_attachment_name = to_c_str(attachment_name);
        unsafe {
            let c_attachment = spSkeleton_getAttachmentForSlotIndex_38(
                self.c_ptr(),
                slot_index as i32,
                c_attachment_name.as_ptr(),
            );
...
impl Drop for Skeleton {
    fn drop(&mut self) {
        if self.owns_memory {
            unsafe {
                spSkeleton_dispose_38(self.c_skeleton.0);
            }
        }
    }
}
