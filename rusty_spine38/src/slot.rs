use crate::{
    ...
    c::{
        ...
        spSlot, spSlotData, spSlotData_setAttachmentName_38, spSlot_setAttachment_38,
        spSlot_setToSetupPose_38,
    },
...
impl Slot {
    ...
    pub unsafe fn set_attachment(&mut self, attachment: Option<Attachment>) {
        attachment.map_or_else(
            || {
                spSlot_setAttachment_38(self.c_ptr(), std::ptr::null_mut());
            },
            |attachment| {
                spSlot_setAttachment_38(self.c_ptr(), attachment.c_ptr());
            },
        );
    }
    ...
    pub fn set_to_setup_pose(&mut self) {
        unsafe {
            spSlot_setToSetupPose_38(self.c_ptr());
        }
    }
...
impl SlotData {
    pub fn set_attachment_name(&mut self, attachment_name: &str) {
        ...
        unsafe { spSlotData_setAttachmentName_38(self.c_ptr(), c_attachment_name.as_ptr()) }
    }
