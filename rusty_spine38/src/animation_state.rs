...
use crate::{
    ...
    c::{
        c_void, spAnimation, spAnimationState, spAnimationStateData, spAnimationState_addAnimation_38,
        spAnimationState_addAnimationByName_38, spAnimationState_addEmptyAnimation_38,
        spAnimationState_apply_38, spAnimationState_clearListenerNotifications_38,
        spAnimationState_clearTrack_38, spAnimationState_clearTracks_38, spAnimationState_create_38,
        spAnimationState_dispose_38, spAnimationState_disposeStatics_38, spAnimationState_getCurrent_38,
        spAnimationState_setAnimation_38, spAnimationState_setAnimationByName_38,
        spAnimationState_setEmptyAnimation_38, spAnimationState_setEmptyAnimations_38,
        spAnimationState_update_38, spEvent, spEventType, spTrackEntry, spTrackEntry_getAnimationTime_38,
    },
...
impl AnimationState {
    ...
    pub fn new(animation_state_data: Arc<AnimationStateData>) -> Self {
        let c_animation_state = unsafe { spAnimationState_create_38(animation_state_data.c_ptr()) };
        unsafe {
    ...
    pub fn update(&mut self, delta: f32) {
        unsafe {
            spAnimationState_update_38(self.c_ptr(), delta);
        }
    }

    pub fn apply(&self, skeleton: &mut Skeleton) -> bool {
        unsafe { spAnimationState_apply_38(self.c_animation_state.0, skeleton.c_ptr()) != 0 }
    }

    /// Clears all animations in all track entries in this animation state.
    pub fn clear_tracks(&mut self) {
        unsafe {
            spAnimationState_clearTracks_38(self.c_ptr());
        }
    }
    ...
    pub fn clear_track(&mut self, track_index: usize) {
        unsafe {
            spAnimationState_clearTrack_38(self.c_ptr(), track_index as i32);
        }
    }
    ...
    pub unsafe fn set_animation_by_name_unchecked(
        ...
        CTmpMut::new(
            self,
            TrackEntry::new_from_ptr(spAnimationState_setAnimationByName_38(
                self.c_ptr(),
                track_index as i32,
    ...
    pub fn set_animation(
        ...
        unsafe {
            CTmpMut::new(
                self,
                TrackEntry::new_from_ptr(spAnimationState_setAnimation_38(
                    self.c_ptr(),
                    track_index as i32,
                    animation.c_ptr(),
                    i32::from(looping),
    ...
    pub unsafe fn add_animation_by_name_unchecked(
        ...
        CTmpMut::new(
            self,
            TrackEntry::new_from_ptr(spAnimationState_addAnimationByName_38(
                self.c_ptr(),
                track_index as i32,
                c_animation_name.as_ptr(),
                i32::from(looping),
    ...
    pub fn add_animation(
        ...
        unsafe {
            CTmpMut::new(
                self,
                TrackEntry::new_from_ptr(spAnimationState_addAnimation_38(
                    self.c_ptr(),
                    track_index as i32,
                    animation.c_ptr(),
                    i32::from(looping),
    ...
    pub fn set_empty_animation(
        ...
        unsafe {
            CTmpMut::new(
                self,
                TrackEntry::new_from_ptr(spAnimationState_setEmptyAnimation_38(
                    self.c_ptr(),
                    track_index as i32,
                    mix_duration,
                )),
    ...
    pub fn add_empty_animation(
        ...
        unsafe {
            CTmpMut::new(
                self,
                TrackEntry::new_from_ptr(spAnimationState_addEmptyAnimation_38(
                    self.c_ptr(),
                    track_index as i32,
                    mix_duration,
                    delay,
    ...
    pub fn set_empty_animations(&mut self, mix_duration: f32) {
        unsafe {
            spAnimationState_setEmptyAnimations_38(self.c_ptr(), mix_duration);
        }
    }
    ...
    pub fn get_current(&self, track_index: usize) -> Option<CTmpRef<'_, Self, TrackEntry>> {
        unsafe {
            let ptr = spAnimationState_getCurrent_38(self.c_ptr(), track_index as i32);
            if !ptr.is_null() {
    ...
    pub fn clear_listener_notifications(&mut self) {
        unsafe {
            spAnimationState_clearListenerNotifications_38(self.c_ptr());
        }
    }
    ...
    pub fn dispose_statics() {
        unsafe {
            spAnimationState_disposeStatics_38();
        }
    }
...
impl Drop for AnimationState {
    fn drop(&mut self) {
        if self.owns_memory {
            ...
            unsafe {
                spAnimationState_dispose_38(self.c_animation_state.0);
            }
        }
    }
}
...
impl TrackEntry {
    ...
    pub fn animation_time(&self) -> f32 {
        unsafe { spTrackEntry_getAnimationTime_38(self.c_ptr()) }
    }
