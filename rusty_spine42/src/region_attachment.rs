use crate::{
    c::{
        c_float, spAttachment, spRegionAttachment, spRegionAttachment_computeWorldVertices_42,
        spRegionAttachment_updateRegion_42, spTextureRegion,
    },
    c_interface::SyncPtr,
    slot::Slot,
...
impl RegionAttachment {
    ...
    pub unsafe fn compute_world_vertices(
        ...
        spRegionAttachment_computeWorldVertices_42(
            self.c_ptr(),
            slot.c_ptr(),
            vertices.as_mut_ptr(),
            offset,
    ...
    pub fn update_region(&mut self) {
        unsafe {
            spRegionAttachment_updateRegion_42(self.c_ptr());
        }
    }
