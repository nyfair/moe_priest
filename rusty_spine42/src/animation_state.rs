...
use crate::{
    ...
    c::{
        c_void, spAnimation, spAnimationState, spAnimationStateData, spAnimationState_addAnimation_42,
        spAnimationState_addAnimationByName_42, spAnimationState_addEmptyAnimation_42,
        spAnimationState_apply_42, spAnimationState_clearListenerNotifications_42,
        spAnimationState_clearNext_42, spAnimationState_clearTrack_42, spAnimationState_clearTracks_42,
        spAnimationState_create_42, spAnimationState_dispose_42, spAnimationState_disposeStatics_42,
        spAnimationState_getCurrent_42, spAnimationState_setAnimation_42,
        spAnimationState_setAnimationByName_42, spAnimationState_setEmptyAnimation_42,
        spAnimationState_setEmptyAnimations_42, spAnimationState_update_42, spEvent, spEventType,
        spTrackEntry, spTrackEntry_getAnimationTime_42, spTrackEntry_getTrackComplete_42,
    },
...
impl AnimationState {
    ...
    pub fn new(animation_state_data: Arc<AnimationStateData>) -> Self {
        let c_animation_state = unsafe { spAnimationState_create_42(animation_state_data.c_ptr()) };
        unsafe {
    ...
    pub fn update(&mut self, delta: f32) {
        unsafe {
            spAnimationState_update_42(self.c_ptr(), delta);
        }
    }

    pub fn apply(&self, skeleton: &mut Skeleton) -> bool {
        unsafe { spAnimationState_apply_42(self.c_animation_state.0, skeleton.c_ptr()) != 0 }
    }

    /// Clears all animations in all track entries in this animation state.
    pub fn clear_tracks(&mut self) {
        unsafe {
            spAnimationState_clearTracks_42(self.c_ptr());
        }
    }
    ...
    pub fn clear_track(&mut self, track_index: usize) {
        unsafe {
            spAnimationState_clearTrack_42(self.c_ptr(), track_index as i32);
        }
    }
    ...
    pub unsafe fn set_animation_by_name_unchecked(
        ...
        CTmpMut::new(
            self,
            TrackEntry::new_from_ptr(spAnimationState_setAnimationByName_42(
                self.c_ptr(),
                track_index as i32,
    ...
    pub fn set_animation(
        ...
        unsafe {
            CTmpMut::new(
                self,
                TrackEntry::new_from_ptr(spAnimationState_setAnimation_42(
                    self.c_ptr(),
                    track_index as i32,
                    animation.c_ptr(),
                    i32::from(looping),
    ...
    pub unsafe fn add_animation_by_name_unchecked(
        ...
        CTmpMut::new(
            self,
            TrackEntry::new_from_ptr(spAnimationState_addAnimationByName_42(
                self.c_ptr(),
                track_index as i32,
                c_animation_name.as_ptr(),
                i32::from(looping),
    ...
    pub fn add_animation(
        ...
        unsafe {
            CTmpMut::new(
                self,
                TrackEntry::new_from_ptr(spAnimationState_addAnimation_42(
                    self.c_ptr(),
                    track_index as i32,
                    animation.c_ptr(),
                    i32::from(looping),
    ...
    pub fn set_empty_animation(
        ...
        unsafe {
            CTmpMut::new(
                self,
                TrackEntry::new_from_ptr(spAnimationState_setEmptyAnimation_42(
                    self.c_ptr(),
                    track_index as i32,
                    mix_duration,
                )),
    ...
    pub fn add_empty_animation(
        ...
        unsafe {
            CTmpMut::new(
                self,
                TrackEntry::new_from_ptr(spAnimationState_addEmptyAnimation_42(
                    self.c_ptr(),
                    track_index as i32,
                    mix_duration,
                    delay,
    ...
    pub fn set_empty_animations(&mut self, mix_duration: f32) {
        unsafe {
            spAnimationState_setEmptyAnimations_42(self.c_ptr(), mix_duration);
        }
    }
    ...
    pub fn get_current(&self, track_index: usize) -> Option<CTmpRef<'_, Self, TrackEntry>> {
        unsafe {
            let ptr = spAnimationState_getCurrent_42(self.c_ptr(), track_index as i32);
            if !ptr.is_null() {
    ...
    pub fn clear_listener_notifications(&mut self) {
        unsafe {
            spAnimationState_clearListenerNotifications_42(self.c_ptr());
        }
    }

    pub fn clear_next(&mut self, entry: &TrackEntry) {
        unsafe {
            spAnimationState_clearNext_42(self.c_ptr(), entry.c_ptr());
        }
    }
    ...
    pub fn dispose_statics() {
        unsafe {
            spAnimationState_disposeStatics_42();
        }
    }
...
impl Drop for AnimationState {
    fn drop(&mut self) {
        if self.owns_memory {
            ...
            unsafe {
                spAnimationState_dispose_42(self.c_animation_state.0);
            }
        }
    }
}
...
impl TrackEntry {
    ...
    pub fn animation_time(&self) -> f32 {
        unsafe { spTrackEntry_getAnimationTime_42(self.c_ptr()) }
    }
    ...
    pub fn track_complete(&self) -> f32 {
        unsafe { spTrackEntry_getTrackComplete_42(self.c_ptr()) }
    }
