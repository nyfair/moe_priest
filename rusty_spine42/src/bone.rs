use crate::{
    c::{
        spBone, spBoneData, spBone_getWorldRotationX_42, spBone_getWorldRotationY_42,
        spBone_getWorldScaleX_42, spBone_getWorldScaleY_42, spBone_isYDown_42, spBone_localToWorld_42,
        spBone_rotateWorld_42, spBone_setToSetupPose_42, spBone_setYDown_42, spBone_update_42,
        spBone_updateAppliedTransform_42, spBone_updateWorldTransform_42,
        spBone_updateWorldTransformWith_42, spBone_worldToLocal_42, spBone_worldToLocalRotation_42,
...
impl Bone {
    ...
    pub fn set_to_setup_pose(&mut self) {
        unsafe {
            spBone_setToSetupPose_42(self.c_ptr());
        }
    }
    ...
    pub fn update_world_transform(&mut self) {
        unsafe {
            spBone_updateWorldTransform_42(self.c_ptr());
        }
    }
    ...
    pub fn update_world_transform_with(
        ...
        unsafe {
            spBone_updateWorldTransformWith_42(
                self.c_ptr(),
                x,
                y,
                rotation,
    ...
    pub fn update_applied_transform(&mut self) {
        unsafe {
            spBone_updateAppliedTransform_42(self.c_ptr());
        }
    }
    ...
    pub fn world_scale_x(&self) -> f32 {
        unsafe { spBone_getWorldScaleX_42(self.c_ptr()) }
    }
    ...
    pub fn world_scale_y(&self) -> f32 {
        unsafe { spBone_getWorldScaleY_42(self.c_ptr()) }
    }
    ...
    pub fn world_to_local(&self, world_x: f32, world_y: f32) -> (f32, f32) {
        ...
        unsafe {
            spBone_worldToLocal_42(self.c_ptr(), world_x, world_y, &mut local_x, &mut local_y);
        }
        (local_x, local_y)
    }
    ...
    pub fn local_to_world(&self, local_x: f32, local_y: f32) -> (f32, f32) {
        ...
        unsafe {
            spBone_localToWorld_42(self.c_ptr(), local_x, local_y, &mut world_x, &mut world_y);
        }
        (world_x, world_y)
    }
    ...
    pub fn world_to_local_rotation(&self, world_rotation: f32) -> f32 {
        unsafe { spBone_worldToLocalRotation_42(self.c_ptr(), world_rotation) }
    }

    /// Transforms a local rotation to a world rotation.
    #[must_use]
    pub fn local_to_world_rotation(&self, local_rotation: f32) -> f32 {
        unsafe { spBone_worldToLocalRotation_42(self.c_ptr(), local_rotation) }
    }
    ...
    pub fn rotate_world(&self, degrees: f32) {
        unsafe {
            spBone_rotateWorld_42(self.c_ptr(), degrees);
        }
    }
    ...
    pub fn set_y_down(y_down: bool) {
        unsafe {
            spBone_setYDown_42(i32::from(y_down));
        }
    }

    #[must_use]
    pub fn is_y_down() -> bool {
        unsafe { spBone_isYDown_42() != 0 }
    }
