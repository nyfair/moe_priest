use crate::{
    c::{
        spAtlasAttachmentLoader_create_42, spAttachmentLoader, spAttachmentLoader_createAttachment_42,
        spAttachmentLoader_dispose_42,
    },
...
impl AttachmentLoader {
    ...
    pub fn new_atlas_loader(atlas: &Atlas) -> Self {
        unsafe {
            let atlas_attachment_loader = spAtlasAttachmentLoader_create_42(atlas.c_ptr());
    ...
    pub fn create_attachment(
        ...
        unsafe {
            ...
            let attachment = spAttachmentLoader_createAttachment_42(
                self.c_ptr(),
                c_skin,
...
impl Drop for AttachmentLoader {
    fn drop(&mut self) {
        unsafe {
            spAttachmentLoader_dispose_42(self.c_ptr());
        }
    }
}
