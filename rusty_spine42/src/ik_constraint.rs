use crate::{
    c::{
        spBone, spIkConstraint, spIkConstraintData, spIkConstraint_setToSetupPose_42,
        spIkConstraint_update_42,
    },
...
impl IkConstraint {
    ...
    pub fn update(&self) {
        unsafe {
            spIkConstraint_update_42(self.c_ik_constraint.0);
        }
    }

    pub fn set_to_setup_pose(&self) {
        unsafe {
            spIkConstraint_setToSetupPose_42(self.c_ik_constraint.0);
        }
    }
