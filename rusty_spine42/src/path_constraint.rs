use crate::{
    c::{
        spBone, spPathConstraint, spPathConstraintData, spPathConstraint_setToSetupPose_42,
        spPathConstraint_update_42, spSlot,
    },
...
impl PathConstraint {
    ...
    pub fn update(&self) {
        unsafe {
            spPathConstraint_update_42(self.c_path_constraint.0);
        }
    }

    pub fn set_to_setup_pose(&self) {
        unsafe {
            spPathConstraint_setToSetupPose_42(self.c_path_constraint.0);
        }
    }
