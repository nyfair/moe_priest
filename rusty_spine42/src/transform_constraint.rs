use crate::{
    c::{
        ...
        spTransformConstraint_setToSetupPose_42, spTransformConstraint_update_42,
    },
...
impl TransformConstraint {
    ...
    pub fn update(&self) {
        unsafe {
            spTransformConstraint_update_42(self.c_transform_constraint.0);
        }
    }

    pub fn set_to_setup_pose(&self) {
        unsafe {
            spTransformConstraint_setToSetupPose_42(self.c_transform_constraint.0);
        }
    }
