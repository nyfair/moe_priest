...
use crate::{
    ...
    c::{
        ...
        spSkeletonData, spSkeleton_create_42, spSkeleton_dispose_42,
        spSkeleton_getAttachmentForSlotIndex_42, spSkeleton_getAttachmentForSlotName_42,
        spSkeleton_setAttachment_42, spSkeleton_setBonesToSetupPose_42, spSkeleton_setSkin_42,
        spSkeleton_setSkinByName_42, spSkeleton_setSlotsToSetupPose_42, spSkeleton_setToSetupPose_42,
        spSkeleton_update_42, spSkeleton_updateCache_42, spSkeleton_updateWorldTransform_42,
        spSkeleton_updateWorldTransformWith_42, spSkin, spSlot, spTransformConstraint,
    },
...
impl Skeleton {
    ...
    pub fn new(skeleton_data: Arc<SkeletonData>) -> Self {
        let c_skeleton = unsafe { spSkeleton_create_42(skeleton_data.c_ptr()) };
        Self {
    ...
    pub fn update_cache(&mut self) {
        unsafe {
            spSkeleton_updateCache_42(self.c_ptr());
        }
    }
    ...
    pub fn update_world_transform(&mut self, physics: Physics) {
        unsafe {
            spSkeleton_updateWorldTransform_42(self.c_ptr(), physics as spPhysics);
        }
    }
    ...
    pub unsafe fn update_world_transform_with(&mut self, parent: &Bone, physics: Physics) {
        spSkeleton_updateWorldTransformWith_42(self.c_ptr(), parent.c_ptr(), physics as spPhysics);
    }

    /// Sets the bones, constraints, slots, and draw order to their setup pose values.
    pub fn set_to_setup_pose(&mut self) {
        unsafe {
            spSkeleton_setToSetupPose_42(self.c_ptr());
        }
    }
    ...
    pub fn set_bones_to_setup_pose(&mut self) {
        unsafe {
            spSkeleton_setBonesToSetupPose_42(self.c_ptr());
        }
    }
    ...
    pub fn set_slots_to_setup_pose(&mut self) {
        unsafe {
            spSkeleton_setSlotsToSetupPose_42(self.c_ptr());
        }
    }
    ...
    pub unsafe fn set_skin(&mut self, skin: &Skin) {
        if skin.owns_memory {
            ...
            unsafe { spSkeleton_setSkin_42(self.c_ptr(), cloned_skin.c_ptr()) };
            self._skin = Some(cloned_skin);
        } else {
            unsafe { spSkeleton_setSkin_42(self.c_ptr(), skin.c_ptr()) };
            self._skin = None;
        }
    ...
    pub unsafe fn set_skin_unchecked(&mut self, skin: &Skin) {
        spSkeleton_setSkin_42(self.c_ptr(), skin.c_ptr());
    }
    ...
    pub unsafe fn set_skin_by_name_unchecked(&mut self, skin_name: &str) {
        ...
        spSkeleton_setSkinByName_42(self.c_ptr(), c_skin_name.as_ptr());
        self._skin = None;
    }
    ...
    pub fn find_path_constraint(
        &self,
        name: &str,
    ) -> Option<CTmpRef<'_, Skeleton, PathConstraint>> {
    ...
    pub fn find_physics_constraint(
        &self,
        name: &str,
    ) -> Option<CTmpRef<'_, Skeleton, PhysicsConstraint>> {
    ...
    pub fn find_physics_constraint_mut(
        &mut self,
        name: &str,
    ) -> Option<CTmpMut<'_, Skeleton, PhysicsConstraint>> {
    ...
    pub fn set_attachment(&mut self, slot_name: &str, attachment_name: Option<&str>) -> bool {
        ...
        attachment_name.map_or_else(
            || unsafe {
                spSkeleton_setAttachment_42(self.c_ptr(), c_slot_name.as_ptr(), std::ptr::null()) != 0
            },
            |attachment_name| {
                let c_attachment_name = to_c_str(attachment_name);
                unsafe {
                    spSkeleton_setAttachment_42(
                        self.c_ptr(),
                        c_slot_name.as_ptr(),
    ...
    pub fn get_attachment_for_slot_name(
        ...
        let c_attachment_name = to_c_str(attachment_name);
        unsafe {
            let c_attachment = spSkeleton_getAttachmentForSlotName_42(
                self.c_ptr(),
                c_slot_name.as_ptr(),
                c_attachment_name.as_ptr(),
            );
    ...
    pub fn get_attachment_for_slot_index(
        ...
        let c_attachment_name = to_c_str(attachment_name);
        unsafe {
            let c_attachment = spSkeleton_getAttachmentForSlotIndex_42(
                self.c_ptr(),
                slot_index as i32,
                c_attachment_name.as_ptr(),
            );
...
impl Drop for Skeleton {
    fn drop(&mut self) {
        if self.owns_memory {
            unsafe {
                spSkeleton_dispose_42(self.c_skeleton.0);
            }
        }
    }
}
